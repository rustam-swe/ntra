                                ...
                                <div class="" id="buy-home" role="tabpanel" aria-labelledby="buy-home-tab">
                                    <div class="registration-form text-dark text-start">
                                        <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6">
                                            <div>
                                                <label class="form-label font-medium text-slate-900 dark:text-white" for="search_phrase">
                                            ...
                                            <div>
                                                <label for="buy-properties"
                                                       class="form-label font-medium text-slate-900 dark:text-white">Branch :</label>
                                                <div class="filter-search-form relative filter-border mt-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="filter-search-form relative filter-border mt-2">
                                                    ...
                                                    <input type="number" name="min_price" id="buy-min-price"
                                                           class="form-input filter-input-box bg-gray-50 dark:bg-slate-800 border-0" placeholder="Min Price">
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="filter-search-form relative mt-2">
                                                    ...
                                                    <input type="number" name="max_price" id="buy-max-price"
                                                           class="form-input filter-input-box bg-gray-50 dark:bg-slate-800 border-0" placeholder="Max Price">
                                                </div>
                                            </div>

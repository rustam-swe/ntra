...
$name = (new Router())->getResourceName('update');
...
<style>
    .form-select {
        background-color: white; /* Fon rangi oq */
        color: black; /* Matn rangi qora */
        border: 1px solid #b7b7b7; /* Default holatda oq ingichka chegara */
        border-radius: 5px; /* Yumshoq burchaklar */
        padding: 10px; /* Ichki bo'shliq */
        width: 100%; /* Kenglik */
        transition: border-color 0.3s ease; /* Animatsiya */
    }

    .form-select:focus {
        border-color: green; /* Fokuslanganida chegarasi yashil bo'lgan */
        outline: none; /* Fokusda kontur olib tashlash */
    }
</style>
            ...
            <div class="layout-specing">
                ...
                <div class="container relative">
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mt-6">
                        <div class="rounded-md shadow dark:shadow-gray-700 p-6 bg-white dark:bg-slate-900 h-fit">
                            <div>
                                ...
                                <div class="preview-box flex justify-center rounded-md shadow dark:shadow-gray-800 overflow-hidden bg-gray-50 dark:bg-slate-800 text-slate-400 p-2 text-center small w-auto max-h-60">
                                    <?php if ($name && $ad->image): ?>
                                        <img id="image-preview" src="../../assets/images/ads/<?= $ad->image; ?>" alt="Image Preview" class="max-h-60">
                                    <?php else: ?>
                                ...
                                <div class="flex justify-between mt-6">
                                    <div>
                                        <?php if (isset($ad->image)): ?>
                                            <form action="/delete/image?name=<?= $name ? $ad->image : ''; ?>&id=<?= $ad->id; ?>" method="post">
                                                <input type="text" name="removeImage" id="removeImage" value="<?= $name ? $ad->image : ''; ?>" hidden>
                        ...
                        <div class="rounded-md shadow dark:shadow-gray-700 p-6 bg-white dark:bg-slate-900 h-fit">
                            <form id="ads-create" action="<?php echo $name ? "/ads/update?id={$ad->id}&image={$ad->image}" : '/ads/create'; ?>" method="post" enctype="multipart/form-data">
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12">
                                        <label for="name" class="font-medium">Sarlavha:</label>
                                        <input name="title" id="name" type="text" class="form-input mt-2" placeholder="Property Title :" value="<?= $name ? $ad->title : ''; ?>">
                                    </div>

                                    <?php if ($name): ?>
                                        <div class="col-span-12"> <!-- Bu yerda mt-4 qo'shildi -->
                                            <label for="status" class="font-medium">Status:</label>
                                            <select name="status" id="status" class="form-select mt-2 w-full border border-blue-500 rounded-md p-2 focus:outline-none focus:ring focus:ring-blue-300">
                                                <option value="active">Active</option>
                                                <option value="noactive">No Active</option>
                                            </select>
                                            <input type="hidden" name="status_id" value="<?= $ad->status_id; ?>">
                                        </div>
                                    <?php endif; ?>
                                </div>

                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-4 col-span-12 mt-6">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <textarea name="description" id="description" class="form-input ps-11" placeholder="E'lon bo'yicha ta'rif...">
                                                <?= $name ? $ad->description : ''; ?>
                                            </textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-4 col-span-12 mt-2">
                                        <label for="sqf" class="font-medium">Manzil:</label>
                                        <div class="form-icon relative mt-2">
                                            <input name="address" id="sqf" type="text" class="form-input ps-11" placeholder="Manzil :" value="<?= $name ? $ad->address : ''; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="md:col-span-4 col-span-12 hidden">
                                    <div class="form-icon relative mt-2">
                                        <input name="user" value="<?= (new Session())->getSession()['id'] ?>" type="number" class="form-input ps-11">
                                    </div>
                                </div>

                                <div class="md:col-span-4 col-span-12 hidden">
                                    <div class="form-icon relative mt-2">
                                        <input name="status_id" value="<?= $name ? $ad->status_id : '' ?>" type="number" class="form-input ps-11">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="md:col-span-5 col-span-12">
                                        <label for="beds" class="font-medium">Narxi:</label>
                                        <div class="form-icon relative mt-2">
                                            <i class="mdi mdi-currency-usd absolute top-2 start-4 text-green-600"></i>
                                            <input name="price" id="beds" type="number" class="form-input ps-11" placeholder="Narxi($) :" value="<?= $name ? $ad->price : ''; ?>">
                                        </div>
                                    </div>

                                    <div class="md:col-span-5 col-span-12">
                                        <label for="price" class="font-medium">Xonalar:</label>
                                        <div class="form-icon relative mt-2">
                                            <i class="mdi mdi-bed absolute top-2 start-4 text-green-600"></i>
                                            <input name="rooms" id="price" type="number" class="form-input ps-11" placeholder="Xonalar :" value="<?= $name ? $ad->rooms : ''; ?>">
                                        </div>
                                    </div>
                                    <br><br><br>
                                </div>

...
<nav id="sidebar" class="sidebar-wrapper sidebar-dark">
    <div class="sidebar-content">
        <div class="sidebar-brand">
            <a href="/profile"><img src="/dashboard/assets/images/logo-light.png" alt=""></a>
        </div>

        <ul class="sidebar-menu border-t border-white/10" data-simplebar style="height: calc(100% - 70px);">
            <li>
                <a href="/profile"><i class="mdi mdi-chart-bell-curve-cumulative me-2"></i>Dashboard</a>
            </li>
            ...
            <li class="sidebar-dropdown">
                ...
                <div class="sidebar-submenu">
                    <ul>
                        <li><a href="/profile/ads/create"><i class="mdi mdi-home-plus me-2"></i>E'lon qo'shish</a></li>
                        <li><a href="/"><i class="mdi mdi-home-city me-2"></i>E'lonlar</a></li>
                    </ul>
                </div>
            </li>
        </ul>

                    ...
                    <div class="group rounded-xl bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
                        <div class="relative">
                            ...
                            <div class="absolute top-4 right-4 flex space-x-2">
                                <form action="ads/like/<?= $ad->id ?>" method="post">
                                ...
                                <form action="ads/dislike/<?= $ad->id ?>" method="post">
                                    <input type="hidden" name="_method" value="dislike">
                                    <button type="submit"
                                            class="btn btn-icon bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-full text-slate-100 dark:text-slate-700 focus:text-red-600 dark:focus:text-red-600 hover:text-red-600 dark:hover:text-red-600">
                        ...
                        <div class="p-6">
                            ...
                            <ul class="pt-6 flex justify-between items-center list-none">
                                ...
                                <li>
                                    <span class="text-slate-400">kim uchun</span>
                                    <p class="text-lg font-medium"><?= $ad->gender  ?></p>
                                </li>
                                <li>
                                    <span class="text-slate-400">likes</span>
                                    <p class="text-lg font-medium"> <?= $ad->like_count ?></p>
                                </li>

                                    ...
                                    <div class="registration-form text-dark ltr:text-start rtl:text-end">
                                        <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6">
                                            ...
                                            <div class="lg:mt-6">
                                                ...
                                                class="btn bg-green-600 hover:bg-green-700 border-green-600
                                                hover:border-green-700 text-white searchbtn submit-btn w-full !h-12
                                                rounded"
                                                >
                                            </div>
                                        </div><!--end grid-->
                ...
                foreach ($ads as $ad): ?>
                    ...
                    <div class="group rounded-xl bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
                        <div class="relative">
                            ...
                            <?php if ((new \App\Session())->getName()) : ?>
                            <?php $user_id = (int) (new \App\Session())->getId();  ?>
                                <form action="/like" method="post">
                                    <div class="absolute top-4 end-4">
                                        <button type="submit" name="like"  value="<?= htmlspecialchars(json_encode(['user_id' => $user_id, 'ad_id' => $ad->id]))?>"
                                        ...
                                        <button type="submit" name="dislike" value="<?= htmlspecialchars(json_encode(['user_id' => $user_id, 'ad_id' => $ad->id])) ?>"
                                                class="btn btn-icon bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-full text-slate-100 dark:text-slate-700 focus:text-red-600 dark:focus:text-red-600 hover:text-red-600 dark:hover:text-red-600">
                                            💔
                                        </button>
                                    </div>

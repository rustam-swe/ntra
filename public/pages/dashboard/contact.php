                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                    <div class="text-center px-6">
                        ...
                        <div class="content mt-7">
                            ...
                            <div class="mt-5">
                                <a href="tel:+152534-468-854" class="btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">+998 77 777 77 77</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center px-6">
                        ...
                        <div class="content mt-7">
                            ...
                            <p class="text-slate-400 mt-3">Uzbekistan, <br> Tashkent</p>

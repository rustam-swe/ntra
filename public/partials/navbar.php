    ...
    <div class="container relative">
        ...
        <ul class="buy-button list-none mb-0">
            ...
            <li class="inline mb-0">
                ...
                <a href="/register"
                   ...
                   class="btn bg-green-600 hover:bg-green-700 border-green-600 dark:border-green-600 text-white rounded-full">register</a>
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu justify-end nav-light">
                ...
                <li><a href="/admin/branches" class="sub-menu-item">Filliallar</a></li>

                <li><a href="admin/ads/create" class="sub-menu-item">E'lon qo'shish</a></li>


                <li><a href="../Navbar/about.php" class="sub-menu-item">About</a></li>

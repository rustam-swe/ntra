<nav id="topnav" class="defaultscroll is-sticky">
    <div class="container relative">
        ...
        <ul class="buy-button list-none mb-0">
            ...
            $check = (new \App\Session())->getName() ? 'logout' : 'register'; ?>
            <li class="sm:inline ps-1 mb-0 hidden">
                <a href="<?= $url ?>"
                   class="btn bg-green-600 hover:bg-green-700 border-green-600 dark:border-green-600 text-white rounded-full"><?= $check ?></a>
            </li>
        </ul>
        <div id="navigation">
            <!-- Navigation Menu-->
